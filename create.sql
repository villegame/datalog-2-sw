...
create table temp_mon_schema.settings (
    settings_id serial primary key,
    settings_name varchar(20),
    settings_value varchar(80)
);
...
create table temp_mon_schema.devices (
    ...
    devices_temp_offset numeric(9,2) default 0.0,
    devices_hum_offset numeric(9,2) default 0.0,
    devices_pres_offset numeric(9,2) default 0.0
);
